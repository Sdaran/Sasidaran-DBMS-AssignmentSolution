...
/* Count of females and male passengers travelled for a minimum distance of 600 KM s*/
...
/*distances from the "Passenger" table which are unique (non-repeated distances) in descending order.*/
SELECT distinct(Distance) FROM Passenger order by distance desc;

/*passenger name and percentage of distance travelled by that passenger from the total distance travelled by all passengers without using user variables */
...
/*distance, price in three categories in table Price*/
